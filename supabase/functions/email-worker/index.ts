...
function template(delivery:Delivery,firstName:string){
  ...
  const messages:Record<string,{subject:string;preheader:string;eyebrow:string;heading:string;body:string;cta:string}>={
    ...
    first_week_ready:{subject:"Your first content week is ready",preheader:"Review the plan and begin creative production.",eyebrow:"PLANNING COMPLETE",heading:"Your first week has a clear direction.",body:"Review the plan, adjust any timing, and start creative production when it feels right.",cta:"Review the week"},
