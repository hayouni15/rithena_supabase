-- Keep the stage aligned with terminal/retry state when recovering expired leases.
...
begin
  ...
  update public.generation_jobs
  set state = 'retrying', stage = 'retry_scheduled', lease_owner = null,
      lease_expires_at = null, next_run_at = now(), error_code = 'lease_expired',
  ...
  update public.generation_jobs
  set state = 'failed', stage = 'attempts_exhausted', lease_owner = null,
      lease_expires_at = null, completed_at = now(), error_code = 'attempts_exhausted',
...
update public.generation_jobs
set stage = 'attempts_exhausted'
where state = 'failed' and error_code = 'attempts_exhausted'
  and stage <> 'attempts_exhausted';
